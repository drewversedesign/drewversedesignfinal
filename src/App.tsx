...
// By using React.lazy, we defer loading the code for each page until the user
// navigates to it. This reduces the initial bundle size, leading to a faster
// initial page load. The <Suspense> component shows a loading skeleton while
// the page component is being fetched.
...
// --- ⚡ Bolt: End Code Splitting ---

const queryClient = new QueryClient();

// A simple, full-page loader component to be used as a fallback for Suspense.
const Loader = () => (
