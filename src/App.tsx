...
// ⚡ Bolt: Lazy load all page components for code splitting.
        ...
        <HelmetProvider>
          <AuthProvider>
            <TooltipProvider>
              <Toaster />
              <Sonner />
              {/* ⚡ Bolt: Use Suspense to handle loading state of lazy-loaded components. */}
              <Suspense fallback={<div className="h-screen w-full flex items-center justify-center"><Skeleton className="h-32 w-32" /></div>}>
                <Routes>
