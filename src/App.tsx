...
// ⚡ Bolt: Lazy load page components to enable route-based code splitting.
// This reduces the initial bundle size, leading to faster page loads.
        ...
        <HelmetProvider>
          <AuthProvider>
            <TooltipProvider>
              <Toaster />
              <Sonner />
              {/* ⚡ Bolt: Use Suspense to show a loading fallback while lazy-loaded components are fetched. */}
