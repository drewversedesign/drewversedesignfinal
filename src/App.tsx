...
// ⚡ Bolt: Lazy load route components to split them into separate chunks.
// This improves initial load time by only loading the code for the current page.
        ...
        <HelmetProvider>
          <AuthProvider>
            <TooltipProvider>
              <Toaster />
              <Sonner />
              {/* ⚡ Bolt: Add a Suspense boundary to show a fallback UI while lazy-loaded components are fetched. */}
