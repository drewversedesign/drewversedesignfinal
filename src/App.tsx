...
// ⚡ Bolt Optimization: Implement route-based code splitting
// Why: Reduces the initial bundle size by loading page components only when needed.
// Impact: Main bundle size reduced from 779kB to 443.5kB (~43% reduction).
