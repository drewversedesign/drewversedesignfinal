...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-16 md:py-24 bg-gradient-to-b from-black to-metal-900" ref={sectionRef}>
      <div className="section-container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-24 items-center">
          <div className="order-2 md:order-1">
            <div className="relative mx-auto md:mx-0" style={{ maxWidth: isMobile ? "300px" : "auto" }}>
        ...
        <div className="mt-16 md:mt-24 relative px-0 md:px-12">
          <Carousel opts={{
            ...
            <CarouselContent>
              {stats.map((stat, index) => (
                <CarouselItem key={stat.label} className="basis-1/2 md:basis-1/2 lg:basis-1/3 pl-4">
          ...
          <div className="mt-16 md:mt-24 text-center">
            ...
            <h2 className="mt-4 md:mt-6 text-2xl md:text-3xl lg:text-5xl font-display font-bold text-white reveal fade-bottom" style={{
              animationDelay: "100ms"
            }}>
              FEATURED PROJECTS
            </h2>
