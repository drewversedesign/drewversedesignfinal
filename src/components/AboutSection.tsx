      ...
      <div className="section-container bg-zinc-50">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-24 items-center">
          <div className="order-2 md:order-1">
            ...
            maxWidth: isMobile ? "300px" : "auto"
              ...
              <div className="aspect-ratio-4/3 overflow-hidden rounded-lg reveal fade-right">
                <img alt="Creative workspace with digital design tools at DrewVerse Design studio" className="w-full h-full object-cover" src="https://github.com/drewversedesign/images-for-drewverse-website/blob/main/%20sample%20website%20designs%20by%20Drewverse%20Design.%20drewversedesign.online%20%20(6).png?raw=true" loading="lazy" width="800" height="600" />
              </div>
              {!isMobile && <div className="absolute -bottom-8 -right-8 w-36 md:w-48 h-36 md:h-48 rounded-lg overflow-hidden reveal fade-left hidden md:block" style={{
              animationDelay: "200ms"
            }}>
                  <img alt="DrewVerse Design logo" src="https://github.com/drewversedesign/images-for-drewverse-website/blob/main/photo_5794068069973345766_x-removebg-preview.png?raw=true" className="w-full h-full object-scale-down transform translate-y-8" loading="lazy" width="192" height="192" />
                </div>}
          ...
          <div className="order-1 md:order-2">
            ...
            }} className="text-2xl md:text-3xl lg:text-5xl font-display font-bold reveal fade-bottom text-zinc-950">
                EMPOWERING DIGITAL <span className="text-balance">GROWTH</span>
              </h2>
              
              <p style={{
              animationDelay: "200ms"
            }} className="font-mono text-sm leading-relaxed max-w-xl reveal fade-bottom text-zinc-950">
        ...
        <div className="mt-8 md:mt-12 relative px-0 md:px-12 bg-zinc-50">
          <Carousel opts={{
          align: "start",
          loop: true
            ...
            <CarouselContent>
              ...
              }} className="glass-card p-4 md:p-6 h-full bg-zinc-950">
                    <div className="rounded-full p-2 md:p-3 inline-block mb-2 md:mb-4 bg-zinc-950">
                      <stat.icon className="h-4 w-4 md:h-6 md:w-6 text-white" aria-hidden="true" />
                    </div>
                    <div className="text-white font-display text-2xl md:text-4xl font-bold bg-zinc-950">
                      {stat.value}
                    </div>
